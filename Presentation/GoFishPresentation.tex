...
\begin{frame}{Null Card Error}
	...
	\includegraphics[width=6cm]{0canvas.png}
	\includegraphics[width=6cm]{1canvas.png}
...
\begin{frame}{Statistics}
	\only<1>{
		\begin{center}
			...
			\includegraphics[width=6cm]{2canvas.png}
			\includegraphics[width=6cm]{3canvas.png}
		\end{center}
	}
	...
	\only<2>{
 		\begin{center}
			...
			\includegraphics[width=6cm]{4canvas.png}
			\includegraphics[width=6cm]{5canvas.png}
		\end{center}
	}
\end{frame}
...
\begin{frame}{What worked?}
	...
	\includegraphics[width=10cm]{6canvas.png}
\end{frame}
